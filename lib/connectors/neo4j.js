...
/**
 * Check existence of Nodes with given label.
 *
 * Examples:
...
/**
 * Check existence of Nodes with given properties.
 *
 * Examples:
...
/**
 * Check existence of Nodes with given labels and properties.
 *
 * Examples:
 ...
 * Note: All old properties and labels will be erased.
 *
 * Examples:
...
/**
 * Check existence of Relationships between two nodes.
 *
 * Examples:
 *   connector.getRelationshipBetweenNodes(1, 2, callback);
 *   connector.getRelationshipBetweenNodes(1, 2, 'TYPE', callback);
 ...
 *
 * @param {String|Number} nodeId - Node id.
 * @param {Object} properties - Properties to replace with.
 * @param {Function} callback - Callback called when finished.
 */
 ...
 *
 * @param {Number|String} nodeId - Node id.
 * @param {Object} properties - Properties to remove.
 * @param {Function} callback - Callback called when finished.
 */
