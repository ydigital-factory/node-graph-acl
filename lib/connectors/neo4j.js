...
Neo4jConnector.prototype.getNodesWithProperties = function (properties, callback) {
	this.db.readNodesWithLabelsAndProperties(undefined, properties, callback);
};
...
Neo4jConnector.prototype.existsNodeWithProperties = function (properties, callback) {
	this.db.readNodesWithLabelsAndProperties(undefined, properties, function(err, roles) {
		if ((typeof roles !== 'undefined') && (roles.length > 0)) {
			callback(err, true);
		} else {
			callback(err, false);
